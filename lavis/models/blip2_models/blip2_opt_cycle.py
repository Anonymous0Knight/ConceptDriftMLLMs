...
@registry.register_model("blip2_cycle")
class Blip2CYCLE(Blip2Base):
    """
    BLIP2 Vicuna model.
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        ...
        "vqa_cycle_coco_opt6.7b": "configs/models/blip2/blip2_vqa_cycle_opt6.7b copy.yaml",
    }
